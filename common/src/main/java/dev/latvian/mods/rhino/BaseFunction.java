...
public class BaseFunction extends IdScriptableObject implements Function {
	...
	protected void initPrototypeId(Context cx, int id) {
		...
		initPrototypeMethod(cx, FUNCTION_TAG, id, s, arity);
	}
	...
	public Object execIdCall(IdFunctionObject f, Context cx, Scriptable scope, Scriptable thisObj, Object[] args) {
		...
		switch (id) {
			...
			case Id_apply:
			case Id_call:
				return ScriptRuntime.applyOrCall(cx, id == Id_apply, scope, thisObj, args);
	...
	public Scriptable createObject(Context cx, Scriptable scope) {
		...
		newInstance.setPrototype(cx, getClassPrototype(cx));
