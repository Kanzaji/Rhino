...
final class InterpretedFunction extends NativeFunction implements Script {
	 ...
	 *                {@link ScriptRuntime#EMPTY_ARGS} to pass empty arguments.
	...
	public Object exec(Context cx, Scriptable scope) {
		...
		if (!ScriptRuntime.hasTopCall(cx)) {
			...
			return ScriptRuntime.doTopCall(this, cx, scope, scope, ScriptRuntime.EMPTY_ARGS, idata.isStrict);
		}
		return Interpreter.interpret(this, cx, scope, scope, ScriptRuntime.EMPTY_ARGS);
	}
